...
description: "Implement ArgumentResolver and ArgumentResolverProvider to parse custom Java types from command arguments and provide tab completions in CraftCommand."
---
