...
description: "Add compile-time-generated parameter validation to CraftCommand commands using @Min, @Max for numeric bounds and @ValidateWith for custom validation methods."
---
