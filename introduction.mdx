...
| Module | Purpose |
|---|---|
| `craftcommand-annotations` | Core annotations: `@Command`, `@Subcommand`, `@Default`, `@Optional`, `@Suggest`, `@Greedy`, `@Resolve` |
| `craftcommand-runtime` | Shared runtime interfaces and base classes used by all platform runtimes |
