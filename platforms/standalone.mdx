...
public class CalculatorCommand {
    ...
    // Nested subcommand class with validation annotations
    @Subcommand("advanced")
...
public class CLIApp {
    public static void main(String[] args) {
        ...
        // Execute a command
        executeLine(manager, "calc add 40 2");   // → Result: 42
        executeLine(manager, "calc sub 100 50"); // → Result: 50
        executeLine(manager, "calc op multiply 6 7"); // → Result: 42
        executeLine(manager, "calc advanced power 2 10"); // → Result: 1024.0

        // Tab-complete suggestions
        suggestLine(manager, "calc op "); // → Suggestions: [add, subtract, multiply, divide]
        suggestLine(manager, "calc advanced "); // → Suggestions: [power, sqrt]
    }
