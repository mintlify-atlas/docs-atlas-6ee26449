...
description: "Complete reference for CraftCommand's core annotations: @Command, @Subcommand, @Default, @Optional, @Greedy, @Name, @Resolve, and @Suggest with attributes and usage examples."
---
