...
description: "API reference for ArgumentResolver<S,T> and ArgumentResolverProvider<S> — CraftCommand's interfaces for parsing command arguments into typed Java values."
---
