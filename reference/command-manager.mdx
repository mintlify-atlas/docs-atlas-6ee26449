...
description: "API reference for CommandManager<S>, StandaloneCommandManager, BukkitCommandManager, and PaperCommandManager — registries for resolvers and commands."
---
